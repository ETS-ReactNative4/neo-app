...
const Leads = ({navigation, route}) => {
  ...
  //                         <Text color={"#fff"} fontSize={18}>{trail.customer.name} </Text>
  //                         <Text color={"#9DA4B2"}>{trail.trail_id} </Text>

  //                     </Space>
  //                     <Space direction={'column'}>
  //                         <Text color={"#9DA4B2"}>{displayFollowTime(trail)} </Text>
  //                         <Text color={"#9DA4B2"}>{trail.no_nights}n {trail.trail_to ? ' to ' + trail.trail_to : ''}</Text>
  ...
  //                         <Icon name={CONSTANT_callStartIcon} style={styles.menu} onPress={() => linkToCallNotes(trail)} />
  //                     </TouchableOpacity>
  //                     <TouchableOpacity style={styles.callnotes}>
              ...
              {/* {modalVisible ?
                                    <View style={styles.centeredView}>
                                        ...
                                        >
                                            ...
                                            >
                                                <Text style={styles.textStyle} onPress={() => setModalVisible(!modalVisible)}>x</Text>
                                            </TouchableOpacity>
                                            <CallNotes modalStatus={modalVisible} trailDetails={callData} tabSelected={handleTab} tabSel={tabName} />

                                        </Modal>
                                    </View>
                                    : (
                                        <Space justifyContent={'center'}><Text style={styles.nodata}></Text></Space>)} */}
            </ScrollView>
          )}
        </Space>
