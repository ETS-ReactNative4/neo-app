...
const EditTrail = ({
  ...
  const [trailStatus, callres, reasons, cities, allUsers] = [...dataApi.master];
  ...
  useEffect(() => {
    ...
    Object.keys(trailDetails).forEach(key => {
      if (!isEqual(trailDetails[key], originalTrailDetails[key])) {
        switch (key) {
          case 'sales_owner':
            body['owner_id'] = trailDetails[key];
            break;
          case 'departure_city':
            body[key] = trailDetails[key];
            console.log('city found', trailDetails[key]);
            break;
          ...
          <Space flexWrap={'wrap'}>
            ...
            <Space direction="column">
              <Space.Item
                ...
                !saving &&
                !isEqual(
                  originalCustomerDetails.last_name,
              ...
              <TextInput
                defaultValue={trail.customer.last_name}
                style={styles.inputField}
                onChangeText={text =>
                  setCustomerDetails({
                    last_name: text,
