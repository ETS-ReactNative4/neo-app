...
import { HotelCostingInterface } from "../../../TypeInterfaces/HotelCostingInterface";
...
export interface HotelVoucherV2Props {
  ...
  navigation: NavigationStackProp<{ hotel: HotelCostingInterface }>;
}
...
const HotelVoucherV2 = ({
  containerStyle = StyleSheet.create({}),
  navigation
}: HotelVoucherV2Props) => {
  const hotel: HotelCostingInterface = navigation.getParam("hotel", {});
