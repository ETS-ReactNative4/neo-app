...
function conditionalPropType(condition, message, fullMessageOverride = false) {
    ...
    if (conditionResult) {
      const parsedMessage =
        typeof message === "function"
          ...
          : message;
      const defaultMessage = `Invalid prop '${propName}' '${
        props[propName]
      }' supplied to '${componentName}'. ${parsedMessage}`;
