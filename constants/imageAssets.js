...
export const CONSTANT_offer = 'offer';
export const CONSTANT_heart = 'heart';
...
export const CONSTANT_TRAVELLER_INTRO = () =>
  require('../assets/images/preTripIntroScreen/1-travellers.png');

export const CONSTANT_CONCIERGE_SUPPORT_INTRO = () =>
  require('../assets/images/preTripIntroScreen/2-concierge-support.png');

export const CONSTANT_TRANSPARENT_PRICING = () =>
  require('../assets/images/preTripIntroScreen/3-transparent-pricing.png');
